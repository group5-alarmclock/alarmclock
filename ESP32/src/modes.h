...
#define BUTTON_ALARM_PIN 22 // 25
#define BUTTON_NEXT_PIN 15  // 32
#define BUTTON_PREV_PIN 33  // 33
#define BUTTON_DO_PIN 32    // 25
...
int isButtonPressed(int buttonPin, unsigned int longPressDuration = 1)
{
    ...
    else if (buttonPin == BUTTON_PREV_PIN)
    {
...
int isButtonPressed2(int buttonPin)
{
    currentButtonState = digitalRead(buttonPin);
